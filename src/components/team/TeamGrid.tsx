 ...
 *  Sales / Dealings & Operations) filters the grid above it. Leadership
 *  lives in its own section above this one — see LeadershipSection. */
  ...
  return (
    <section className="bg-[var(--inst-bg)] px-6 py-20 lg:px-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div role="tablist" aria-label="Team department" className="mb-10 flex flex-wrap justify-center gap-2">
          {TABS.map((tab) => {
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filtered.length === 0 ? (
              <p className="py-16 text-center text-[var(--inst-text)]">
                New team members are joining this desk soon.
              </p>
            ) : (
