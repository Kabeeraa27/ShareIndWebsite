          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="flex h-28 w-28 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-white p-2"
              >
                <Image
                  src="/app-qrcode.jpg"
              ...
              <div className="flex flex-col justify-between" style={{ height: "7rem" }}>
                <a
                  href="https://play.google.com/store/apps/details?id=com.tradingapp.shareindia&pli=1"
                  target="_blank"
                  rel="noopener noreferrer"
